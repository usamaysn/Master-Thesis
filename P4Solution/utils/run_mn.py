...
class ExerciseRunner:
    ...
    def run_control_plane_app(self):
        self.logger("Running control plane application.")
        control_plane_process = subprocess.Popen(['python', 'controlplane.py'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        self.logger("Control plane application started with PID: %d" % control_plane_process.pid)
